<title>Tambah calon | E-Pilketos</title>	
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="index.php"><svg class="glyph stroked home"><use xlink:href="#stroked-home"></use></svg></a></li>
				<li class="active"><a href="?p=calon">Calon</a></li><li>Tambah Calon</li>
			</ol>
		</div><!--/.row-->
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<img src="" id="output1" class="img-responsive" style="height: 300px;" alt="
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<textarea name="visi" class="form-control" id="visi" cols="30" rows="10" placeholder="Visi"></textarea>
									</div>
									<div class="form-group">
										<label for="misi">Misi</label>
										<textarea name="misi" class="form-control" id="misi" cols="30" rows="10" placeholder="Misi"></textarea>
									</div>
								</div>
							</div>
